...
- **Link**: [NeetCode](https://neetcode.io/problems/find-minimum-in-rotated-sorted-array) | [LeetCode 153](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/)
...
Output: 11
Explanation: The original array was [11,13,15,17] and it was rotated 4 times (back to original order).
```
